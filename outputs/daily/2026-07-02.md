...
Generated on 2026-07-02T07:19:57Z.

Found 9 recommended papers.

## Highlights

### 1. CFlowAMP: Property controllable De Novo AMP design via integrating ESM-2 with conditional flow matching.
...
### 2. Evaluating Protein Language Model Embeddings for Viral Clade Assignment.
...
### 3. AI-driven discovery of GPNMB CAR-T cells as a multi-cancer therapy

- **Status:** SEEN | **Source:** Cell | **Date:** 2026
- **Authors:** Unknown authors
- **Topics:** Binders and therapeutics
- **Why it matched:** AI-driven, CAR-T, GPNMB
...
### 4. DeepSSInter: Protein-protein contact prediction with a structure-aware protein language model.
...
### 5. Prediction of cyclin-dependent proteins using pre-trained protein language models and effective neural network architectures.
...
### 6. PCTPS: Accurate prediction of phase-separated proteins using protein language model embeddings and a CTN-KAN framework.
...
### 7. A deep mutational scanning-informed protein language model predicts SARS-CoV-2 evolution dynamics with spatiotemporal resolution.

- **Status:** SEEN | **Source:** PubMed | **Date:** 2026 Jul 01
- **Authors:** Yang S, Luo X, Luo J et al.
- **Topics:** Sequence design, Protein language models
- **Why it matched:** protein language model, protein, mutation, sequence
- **Link:** https://pubmed.ncbi.nlm.nih.gov/42204343/
...
### 8. OTalign: Optimal Transport Alignment for Remote Protein Homologs Using Protein Language Model Embeddings.
...
### 9. A PLM-based method for predicting protein ion channel modulators for drug discovery and safety evaluation.
